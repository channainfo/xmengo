...
const Landing: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      {/* Features Section */}
      <section className="px-6 py-16 bg-gradient-to-b from-white to-pink-50 dark:from-gray-800 dark:to-gray-900">
      ...
      {/* CTA Section */}
      <section className="px-6 py-16 bg-gradient-to-r from-pink-100 to-orange-100 dark:from-pink-900 dark:from-opacity-30 dark:to-orange-900 dark:to-opacity-30">
