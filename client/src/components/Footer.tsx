    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Fmengo</h3>
            <p className="text-gray-300">
              A modern dating platform with cryptocurrency payments and multi-platform authentication.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">support@fmengo.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Fmengo. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
